 ...
 * @author Turna
 */
public class ServiceLoadCell2 implements MqttCallback{
  
    private static final String UID = "vcn"; // Links oben
    ...
    private final MQTTCommunication communication;
     ...
     public ServiceLoadCell2() throws MqttException {
    ...
    public static void main(String[] args) throws MqttException, Exception {
        ...
        ServiceLoadCell2 service=new ServiceLoadCell2();
