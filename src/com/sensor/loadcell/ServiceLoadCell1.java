 ...
 * @author Turna
 */
public class ServiceLoadCell1 implements MqttCallback{
  
    private static final String UID = "vcQ"; // Rechts unten
    ...
    private final MQTTCommunication communication;
     ...
     public ServiceLoadCell1() throws MqttException {
    ...
    public static void main(String[] args) throws MqttException, Exception {
        ...
        ServiceLoadCell1 service=new ServiceLoadCell1();
		...
		// Get threshold callbacks with a debounce time of 1 second (1000ms) = 30 sek
