 ...
 * @author Turna
 */
public class ServiceLoadCell5 implements MqttCallback{
  
    private static final String UID = "***"; // Vorne Rechts
    ...
    private final MQTTCommunication communication;
     ...
     public ServiceLoadCell5() throws MqttException {
    ...
    public static void main(String[] args) throws MqttException, Exception {
        ...
        ServiceLoadCell5 service=new ServiceLoadCell5();
