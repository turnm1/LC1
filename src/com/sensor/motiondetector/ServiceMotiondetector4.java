 ...
 * @author Turna
 */
public class ServiceMotiondetector4 implements MqttCallback{
  ...
  public final static String BASE_SENSOR_ID = "Motion Detector";
    ...
    private final MQTTCommunication communication;
     ...
     public ServiceMotiondetector4() throws MqttException {
    ...
    public static void main(String[] args) throws MqttException, Exception {
                ...
                ServiceMotiondetector4 service=new ServiceMotiondetector4();
