 ...
 * @author Turna
 */
public class ServiceMotiondetector5 implements MqttCallback{
  ...
  public final static String BASE_SENSOR_ID = "Motion Detector";
    ...
    private final MQTTCommunication communication;
     ...
     public ServiceMotiondetector5() throws MqttException {
    ...
    public static void main(String[] args) throws MqttException, Exception {
                ...
                ServiceMotiondetector5 service=new ServiceMotiondetector5();
