 ...
 * @author Turna
 */
public class ServiceMotiondetector1 implements MqttCallback{

    	private static final String UID = "wrW"; // Change to your UID
  ...
  public final static String BASE_SENSOR_ID = "Motion Detector";
    ...
    private final MQTTCommunication communication;
     ...
     public ServiceMotiondetector1() throws MqttException {
    ...
    public static void main(String[] args) throws MqttException, Exception {
                ...
                ServiceMotiondetector1 service=new ServiceMotiondetector1();
