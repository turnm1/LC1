 ...
 * @author Turna
 */
public class ServiceDistanceIr3 implements MqttCallback{
    ...
    private final MQTTCommunication communication;
     ...
     public ServiceDistanceIr3() throws MqttException {
    ...
    public static void main(String[] args) throws MqttException, Exception {
        ...
        ServiceDistanceIr3 service=new ServiceDistanceIr3();
