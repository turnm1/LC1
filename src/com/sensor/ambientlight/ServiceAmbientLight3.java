 ...
 * @author Turna
 */
public class ServiceAmbientLight3 implements MqttCallback{

    private final MQTTCommunication communication;   
    
    private static final String UID = "yhZ"; // Change to your UID
    ...
    */
     public ServiceAmbientLight3() throws MqttException {
    ...
    */
    ...
    public static void main(String[] args) throws MqttException, Exception {
                ...
                ServiceAmbientLight3 service=new ServiceAmbientLight3();
