 ...
 * @author Turna
 */
public class ServiceAmbientLight4 implements MqttCallback{

    private final MQTTCommunication communication;   
    
    private static final String UID = "m1L"; // Kueche
    private final static String ROOM = "Kueche";
    ...
    */
     public ServiceAmbientLight4() throws MqttException {
    ...
    */
    ...
    public static void main(String[] args) throws MqttException, Exception {
                ...
                ServiceAmbientLight4 service=new ServiceAmbientLight4();
