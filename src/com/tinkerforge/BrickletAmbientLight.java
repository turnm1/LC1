...
public class BrickletAmbientLight extends Device {
	 ...
	 * {@link BrickletAmbientLight#setIlluminanceCallbackThreshold(char, int, int)} is reached.
	 ...
	 */
	public void setIlluminanceCallbackThreshold(char option, int min, int max) throws TimeoutException, NotConnectedException {
	...
	/**
	 * Returns the threshold as set by {@link BrickletAmbientLight#setIlluminanceCallbackThreshold(char, int, int)}.
	 */
	 ...
	 * 
	 * * {@link BrickletAmbientLight#setIlluminanceCallbackThreshold(char, int, int)},
