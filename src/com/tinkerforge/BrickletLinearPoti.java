...
public class BrickletLinearPoti extends Device {
	...
	public final static String DEVICE_DISPLAY_NAME = "Linear Poti Bricklet";
	 ...
	 * {@link BrickletLinearPoti#setPositionCallbackThreshold(char, int, int)} is reached.
	 ...
	 */
	public void setPositionCallbackThreshold(char option, int min, int max) throws TimeoutException, NotConnectedException {
	...
	/**
	 * Returns the threshold as set by {@link BrickletLinearPoti#setPositionCallbackThreshold(char, int, int)}.
	 */
	 ...
	 * 
	 * * {@link BrickletLinearPoti#setPositionCallbackThreshold(char, int, int)},
