...
public class BrickServo extends Device {
	 ...
	 * .. versionadded:: 2.0.1$nbsp;(Firmware)
	 */
	public boolean isPositionReachedCallbackEnabled() throws TimeoutException, NotConnectedException {
	 ...
	 * .. versionadded:: 2.0.1$nbsp;(Firmware)
	 */
	public boolean isVelocityReachedCallbackEnabled() throws TimeoutException, NotConnectedException {
