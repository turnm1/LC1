...
public class BrickletVoltage extends Device {
	 ...
	 * sensor.
	 * 
	 * {@link BrickletVoltage.VoltageListener} is only triggered if the voltage has changed since the
	 * last triggering.
	 */
	...
	/**
	 * This listener is triggered periodically with the period that is set by
	 * {@link BrickletVoltage#setAnalogValueCallbackPeriod(long)}. The parameter is the analog value of the
	 * sensor.
	 * 
	 * {@link BrickletVoltage.AnalogValueListener} is only triggered if the voltage has changed since the
	 * last triggering.
	 */
	 ...
	 * listener {@link BrickletVoltage.VoltageListener} and set the period with 
	 ...
	 * listener {@link BrickletVoltage.AnalogValueListener} and set the period with 
	 ...
	 * periodically. A value of 0 turns the listener off.
	 * 
	 * {@link BrickletVoltage.AnalogValueListener} is only triggered if the analog value has changed since the
	 * last triggering.
	 * 
	 * The default value is 0.
	 */
