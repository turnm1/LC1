...
public class BrickletHumidity extends Device {
	...
	public final static String DEVICE_DISPLAY_NAME = "Humidity Bricklet";
	 ...
	 * {@link BrickletHumidity#setHumidityCallbackThreshold(char, int, int)} is reached.
	 ...
	 */
	public void setHumidityCallbackThreshold(char option, int min, int max) throws TimeoutException, NotConnectedException {
	...
	/**
	 * Returns the threshold as set by {@link BrickletHumidity#setHumidityCallbackThreshold(char, int, int)}.
	 */
	 ...
	 * 
	 * * {@link BrickletHumidity#setHumidityCallbackThreshold(char, int, int)},
