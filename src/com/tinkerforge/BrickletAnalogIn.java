...
public class BrickletAnalogIn extends Device {
	...
	public final static String DEVICE_DISPLAY_NAME = "Analog In Bricklet";
	 ...
	 * {@link BrickletAnalogIn#setVoltageCallbackThreshold(char, int, int)} is reached.
	...
	/**
	 * Returns the threshold as set by {@link BrickletAnalogIn#setVoltageCallbackThreshold(char, int, int)}.
	 */
	 ...
	 * 
	 * * {@link BrickletAnalogIn#setVoltageCallbackThreshold(char, int, int)},
