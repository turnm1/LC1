...
public class BrickletGPS extends Device {
	 ...
	 *  "Value", "Description"
	 * 
	 *  "1", "No Fix, {@link BrickletGPS#getCoordinates()}, {@link BrickletGPS#getAltitude()} and {@link BrickletGPS#getMotion()} return invalid data"
	 *  "2", "2D Fix, only {@link BrickletGPS#getCoordinates()} and {@link BrickletGPS#getMotion()} return valid data"
	 *  "3", "3D Fix, {@link BrickletGPS#getCoordinates()}, {@link BrickletGPS#getAltitude()} and {@link BrickletGPS#getMotion()} return valid data"
	 * \endverbatim
	 * 
