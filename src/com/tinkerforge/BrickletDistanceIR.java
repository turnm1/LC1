...
public class BrickletDistanceIR extends Device {
	 ...
	 * {@link BrickletDistanceIR#setDistanceCallbackThreshold(char, int, int)} is reached.
	...
	/**
	 * Returns the threshold as set by {@link BrickletDistanceIR#setDistanceCallbackThreshold(char, int, int)}.
	 */
	 ...
	 * 
	 * * {@link BrickletDistanceIR#setDistanceCallbackThreshold(char, int, int)},
